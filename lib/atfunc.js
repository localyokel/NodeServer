...
exports.setup = function(aid_data,new_adtag,adpos,tagkeys,size,req,res) {

	var siteid = aid_data[0];
	var zoneid = aid_data[1];
	var nadpos = aid_data[2];
	var div_id = Math.floor(Math.random()*99999);
...
exports.process = function(new_tag, site_id, zone_id, tagkeys, adpos, dbadpos, size) {
